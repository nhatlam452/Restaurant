...
public class CaoThangActivity extends AppCompatActivity {
    ...
    Button buttonReserveCT;
    CardView cardViewCTLocation;
    String locationCT = "83 Cao Thang Phuong 4 Quan 3";


    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.bottom_sheet_caothang);
        ...
        final EditText edChair =  layout_dialog_add.findViewById(R.id.edChair);  // editext này lấy ở file layout_custom_dialog
        final TextView edTime =   layout_dialog_add.findViewById(R.id.edTime);
        final TextView edDate =   layout_dialog_add.findViewById(R.id.edDate);
        final Spinner spRoom =   layout_dialog_add.findViewById(R.id.spRoom);
        ...
        edTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(CaoThangActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        edDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog date = new DatePickerDialog(CaoThangActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        builder.setIcon(R.drawable.ic_house); // nếu bạn không thích thì comment dòng này lại
        String[] arrTT = {"Neutral Room","VIP1 Room","VIP2 Room"};
        ArrayAdapter<String> spnAdapter = new ArrayAdapter<>(CaoThangActivity.this,
                android.R.layout.simple_spinner_dropdown_item,arrTT);
        spRoom.setAdapter(spnAdapter);
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                db.collection("TABLE")
                        ...
                        .addOnSuccessListener(new OnSuccessListener <DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Toast.makeText(CaoThangActivity.this, "Dat ban thanh cong", Toast.LENGTH_SHORT).show();
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(CaoThangActivity.this, "Đặt bàn thất bại", Toast.LENGTH_SHORT).show();
                ...
                Intent i = new Intent(CaoThangActivity.this,GiftActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void setNotification(String notificaitons) {
        ...
        Notification notification = new NotificationCompat.Builder(CaoThangActivity.this,"RESTAURANT")
        ...
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        Geocoder geocoder = new Geocoder(CaoThangActivity.this, Locale.getDefault());
    ...
    private void initUI() {
        linearLayoutManagerLocation = findViewById(R.id.linearLayoutLocationCaoThang);
        linearLayoutManagerPhone = findViewById(R.id.linearLayoutPhoneCaoThang);
        buttonReserveCT = findViewById(R.id.btnReserveCT);
        cardViewCTLocation = findViewById(R.id.cardViewLocationCaoThang);
    }
    @Override
